...
$filtro="WHERE fecha='".$fecha."' and proyecto='".$proyecto."'";
...
//insert
	...
	$query="INSERT INTO $tablename (descripcion,fecha,proyecto) VALUES ('".$descrip."','".$fecha."','".$proyecto."');";
	//echo $q
...
$query="UPDATE mis_relojes SET descripcion='".$descrip."' WHERE fecha='".$fecha."' ;";
//echo $query;
