...
Script =  "<div style='font-size:18px;font-weight:bold;'>"+Fecha+"</div>"+"<div style='font-size:32px;'>"+Hora + ":" + Minutos + " "+ "</div> ";
...
<table width="66%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="35%" align="center" valign="top" bgcolor="#EBEBEB" >
    			<div style="padding-top:10px; background-color:#EBEBEB; height:100%; padding-left:10px; padding-right:10px;">
                <p align="center" class="Estilo12"><strong>R2D2</strong> "ARTURITO"</p>
                <p align="center" class="Estilo12"><span class="Estilo14">es mi ayudante </span><span class="Estilo13">y tanque de ideas.</span><img src="r2d2.jpg" ></p>
				</div>
<p style="color:#EBEBEB;">musica,tvgoogle,spy,detector movimiento,camaras ciudad,escritorio remoto   </p>



         </td>
		 <td width="2%" > <div style=" width:20px;"></div></td>
        <td width="63%" valign="top" bgcolor="EBEBEB">
...
<div id="milist" style="float:left; width:100%; height:132px; overflow: auto;"></div>
<div>
